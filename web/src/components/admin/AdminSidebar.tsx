...
export default function AdminSidebar({ collapsed, onToggle }: { collapsed: boolean; onToggle: () => void }) {
  ...
  return <aside className="admin-sidebar">
    ...
    <nav aria-label={t('nav.platform')}>
      ...
      <SidebarLink collapsed={collapsed} to="/admin/notifications" icon="bell" label={t('nav.notifications')} />
      ...
      <SidebarLink collapsed={collapsed} to="/admin/extensions" icon="device" label={t('nav.extensions')} />
