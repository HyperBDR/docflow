...
export type IconName = 'ai' | 'analytics' | 'animation' | 'arrowDown' | 'arrowUp' | 'check' | 'clock' | 'copy' | 'cursor' | 'delete' | 'device' | 'download' | 'edit' | 'eye' | 'folder' | 'grid' | 'image' | 'layout' | 'link' | 'list' | 'message' | 'more' | 'move' | 'palette' | 'play' | 'plus' | 'publish' | 'search' | 'settings' | 'share' | 'tag' | 'target' | 'text' | 'unlink' | 'users' | 'warning'
