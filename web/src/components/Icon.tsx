...
export type IconName = 'ai' | 'analytics' | 'animation' | 'arrowDown' | 'arrowRight' | 'arrowUp' | 'bell' | 'book' | 'check' | 'chevronLeft' | 'chevronRight' | 'clock' | 'close' | 'copy' | 'cursor' | 'database' | 'delete' | 'device' | 'download' | 'edit' | 'eye' | 'eyeOff' | 'folder' | 'globe' | 'grid' | 'help' | 'home' | 'image' | 'layout' | 'link' | 'list' | 'lock' | 'logout' | 'menu' | 'message' | 'more' | 'move' | 'palette' | 'play' | 'plus' | 'publish' | 'record' | 'redo' | 'search' | 'settings' | 'share' | 'shield' | 'support' | 'tag' | 'target' | 'text' | 'undo' | 'unlink' | 'user' | 'users' | 'warning'
...
export default function Icon({ name, size = 16 }: { name: IconName; size?: number }) {
  ...
  const content: Record<IconName, React.ReactNode> = {
    ...
    redo: <><path d="M20 8h-9a6 6 0 0 0-6 6v2"/><path d="m16 4 4 4-4 4"/></>,
    ...
    undo: <><path d="M4 8h9a6 6 0 0 1 6 6v2"/><path d="m8 4-4 4 4 4"/></>,
