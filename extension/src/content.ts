...
function showRecordingSetup(message: {
  ...
  shadow.innerHTML = `<style>
    ...
    *{box-sizing:border-box}.backdrop{position:fixed;inset:0;display:grid;place-items:center;padding:24px;background:#0b1020a8;backdrop-filter:blur(5px)}
    ...
    .diagnostics{width:min(560px,calc(100% - 140px));display:grid;gap:8px;margin:-8px auto 22px}.diagnostic{display:grid;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:10px;padding:10px 12px;border:1px solid #eee5d1;border-radius:12px;background:linear-gradient(180deg,#fffefa,#fcf9f1);box-shadow:0 -6px 16px #5e4a1b0a,0 9px 20px #5e4a1b10}.diagnostic>span{width:34px;height:34px;display:grid;place-items:center;border-radius:9px;color:#a97a30;background:#f8efd9}.diagnostic>span svg{width:18px;height:18px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.diagnostic div{min-width:0}.diagnostic strong{display:block;margin-bottom:2px;color:#6f5a34;font-size:12px}.diagnostic p{color:#8b7753;font-size:10px;line-height:1.4}.diagnostic button{min-width:88px;padding:7px 10px;border:1px solid #dfd1ae;border-radius:8px;color:#765d2c;background:#fffefb;font:700 10px inherit;cursor:pointer;white-space:nowrap}.diagnostic button:hover{background:#faf4e5}.diagnostic button:disabled{opacity:.55;cursor:progress}
    ...
    @media(max-width:620px){.modes,.config-row{grid-template-columns:1fr}.mode{min-height:178px}.diagnostics{width:calc(100% - 48px)}.diagnostic{grid-template-columns:32px 1fr}.diagnostic button{grid-column:2;width:max-content}.modal{border-radius:15px}.head,.body,.tutorial{padding-left:18px;padding-right:18px}.actions{padding-left:18px;padding-right:18px}}
    ${aiSettingsStyles}
