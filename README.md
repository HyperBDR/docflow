...
平台支持 Google OpenID Connect 登录、受控自动注册和现有账号安全绑定。Google Cloud Client ID、Client Secret、回调地址和用户范围的完整配置流程见 [DocFlow Google Sign-in 配置指南](docs/google-sign-in-setup.md)。
